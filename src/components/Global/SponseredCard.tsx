...
function Productcard({ image, name, price, seller, description, id }: productCard) {
    ...
    return (
        <div className="relative w-[45vw] md:w-72 lg:h-[350px]  p-0 h-[auto] mb-2 cursor-pointer">
            <div className="absolute top-0 right-[5px] lg:left-0 z-10 ">
                <button className="bg-blue-800 text-[8px] px-[3px] py-[1px] lg:text-[10px] text-white lg:px-2 lg:py-1 rounded ">
                    Sponsored
                </button>
            </div>
            <div
                className="flex h-full py-1 flex-col lg:flex-col max-w-sm rounded-lg radius-2xl  border-gray-300 mb-2  relative  lg:hover:bg-green-100 hover:scale-105 duration-300"
