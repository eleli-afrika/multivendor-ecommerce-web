...
function Productcard({ image, name, price, id }: productCard) {
  ...
  return (
    <div className="relative h-[250px] lg:h-[300px] w-[42vw] md:w-[200px] xl:w-[200px] mb-4 hover:shadow-lg">
      ...
      <div
        className="flex h-full flex-col lg:flex-col rounded-[8px] sm:bg-white border-gray-300 relative hover:scale-105 duration-300"
